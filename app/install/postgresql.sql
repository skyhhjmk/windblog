...
COMMENT ON COLUMN media.custom_fields IS '自定义字段';
...
CREATE INDEX idx_media_custom_fields ON media USING GIN (custom_fields);
...
VALUES (default, '雨云',
        ...
        '超高性价比云服务商，使用优惠码github注册并绑定微信即可获得5折优惠',
        '{}'::jsonb,
        '2025-9-26 11:00:00+08', '2022-12-23 12:05:07', null);
